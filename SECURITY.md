...
## What hotgrin does on your machine

hotgrin is a transpiler and command-line tool. Being honest about what it
does helps you reason about its security posture:

- It reads your `.hot` source files and any local libraries you `use`.
...
hotgrin programs you trust, exactly as you would with any source you
